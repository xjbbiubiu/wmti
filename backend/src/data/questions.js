...
const questions = [
  ...
  {
    id: 14,
    content: '演唱会进行到一半，你的手机突然没电了，荧光棒也被人踩坏了。此时你：',
    options: [
      { key: 'A', content: '洋葱层层叠叠的情绪只有自己在消化——整个人都emo了', scores: { w: 0, m: 0, l: 0, s: 3 } },
      { key: 'B', content: '管他的！没有手机我也能嗨，没有荧光棒我还有手！', scores: { w: 0, m: 0, l: 0, s: 2 } },
      { key: 'C', content: '找旁边的人借个充电宝，顺便交个五迷朋友', scores: { w: 0, m: 0, l: 0, s: 1 } },
      { key: 'D', content: '无所谓——反正这一刻我已经很满足了', scores: { w: 0, m: 0, l: 0, s: 0 } }
    ]
  },
  {
    id: 15,
