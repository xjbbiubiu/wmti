...
router.post('/submit', (req, res) => {
  ...
  const finalSongLyrics = {
    ...
    '离开地球表面': '丢掉手表 丢外套 丢掉背包 再丢唠叨。一颗心噗通噗通的狂跳，一瞬间烦恼烦恼烦恼全忘掉。我甩掉地球 地球甩掉，只要越跳越高！',
    '干杯': '会不会有一天时间真的能倒退，退回你的我的回不去的悠悠的岁月。',
    '最重要的小事': '这一刻最重要的事，是属于你最小的事。',
    '我不愿让你一个人': '我不愿让你一个人，一个人在人海浮沉。',
    '垃圾车': '有你我才未孤单，有你的陪伴我才有靠山。',
    '洋葱': '如果你愿意一层一层一层地剥开我的心，你会鼻酸，你会流泪。',
    '人生有限公司': '人生有限公司，没有一天能请假。人在哪里跌倒，就在哪里趴一下。',
    '盛夏光年': '我骄傲的破坏，我痛恨的平凡。放弃规则，放纵去爱，我不转弯。',
    '有些事不做一辈子都不会做了': '然而大多的自我 都紧抓着 某个理由 每个渺小的理由 都困住自由 有些事情还不做 你的理由 会是什么',
    ...
    '任意门': '任意门通向了音乐，任意门外我们都任意的飞，是自由的滋味。我们曾走过无数地方和无尽岁月，搭着肩环游无法遗忘的光辉世界。',
    '任性': '就为了你为了你勇敢任性，世界再对我再错又有何惧。',
    '憨人': '我不是头脑空空，我不是一只米虫。甘愿来做憨人，我有我的路，有我的梦。',
    '成名在望': '那黑的终点可有光，那夜的尽头可会转弯。成名在望，不在乎有没有掌声。',
    '我心中尚未崩坏的地方': '至少在我的心中还有个尚未崩坏的地方，其实我们都一模一样，无名却充满了渴望。',
    '恒星的恒心': '你和我看星星，那夜空多神秘。天很黑风很急，你把我抱得很紧。用恒星的恒心等你，等着你等着你。',
    '雌雄同体': '也许会有一天，银河中有另一个星球。你会不会就是我的克隆。',
    '洗衣机': '洗衣机洗过多少江湖，多久多长多惨烈。脱水总是全心又全力，直到颤抖了身体。',
    '诺亚方舟': '再见 草莓甜甜圈，再见 街角咖啡店 落下雨点。晚安 鹦鹉和孔雀，花豹和人类望着海面。让诺亚方舟 航向了 海平线，让诺亚方舟 航向了 天际线。',
    '三个傻瓜': '分不清 他傻瓜 你傻瓜 我傻瓜 谁傻瓜。傻不傻瓜 时间一样追杀，傻瓜啊 一转眼 就老花 一转眼 就白发。',
    '步步': '天空和我的中间，只剩倾盆的思念。如果相识不能相恋，是不是还不如擦肩。',
    '后来的我们': '后来的我们，依然走着，只是不再并肩了。在某处另一个你留下了，在那里另一个我微笑着。',
    '伤心的人别听慢歌': '不管了不想了不等了不要不快乐，伤心的人别听慢歌。',
    '第二人生': '生命不是过程而是美丽旅程，第一站叫天真第二站叫青春，下一站的名字等你去确认。',
    '如果我们不曾相遇': '偶然与巧合 舞动了蝶翼 谁的心头风起 前仆而后继 万千人追寻 荒漠唯一菩提',
    '温柔': '不知道不明了不想要，为什么我的心。明明是想靠近，却孤单到黎明。如果你真的爱我，愿你自由飞吧。',
    '什么歌': '当岁月轻飘飘飘的溜走，我们都哎呀呀呀白了头。才知道最重要的会是什么，直到最后，我拥有你你拥有我。'
  };
